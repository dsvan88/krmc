...
return [
    ...
    "If you make a mistake, don't worry, tell the administrator about it and he will quickly fix it😏" => "Если допустили ошибку - не волнуйтесь, сообщите об этом администратору и он быстренько это исправит😏",
    ...
    'Is it you?' => 'Это Вы?',
    "*This nickname will be your, after administrator's approve." => "Этот псевдоним будет вашим, после подтвердження администратором.",
