...
return [
    ...
    "If you make a mistake, don't worry, tell the Administrators about it and he will quickly fix it😏" => "Если допустили ошибку - не волнуйтесь, сообщите об этом администратору и он быстренько это исправит😏",
