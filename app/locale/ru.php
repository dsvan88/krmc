...
return [
    ...
    "<b>%s</b>, nice to meet you!\nYou successfully registered in our system!\n\nIf you make a mistake, don't worry, tell the administrator about it and he will quickly fix it😏" => "<b>%s</b>, приятно познакомиться!\nВы успешно зарегистрировались в нашей системе!\nЕсли Вы допустили ошибку - не беспокойтесь, просто сообщите об этом администратору и он быстренько это исправит😏",
