...
<u>/promo</u> <i>// Зафиксувати якесь повідомлення, що додається знизу команди /week.</i> Текст до першого переносу рядку - заголовок, до другого - підзаголовок та все, що нижче - текст повідомлення. Зразок:
    /promo Заголовок
Підзголовок
