...
return [
    ...
    "<b>%s</b>, nice to meet you!\nYou successfully registered in our system!\n\nIf you make a mistake, don't worry, tell the administrator about it and he will quickly fix it😏" => "<b>%s</b>, приємно познайомитись!\nВи успішно зареєструвались в нашій системі!\nЯкщо Ви допустили помилку - не переймайтесь, просто повідомте про це адмінистратору й він швиденько це виправить😏",
