...
return [
    ...
    '{{ HEADER_ASIDE_MENU_ADD_PAGE }}' => 'Add Page',
    '{{ HEADER_ASIDE_MENU_USERS_LISTS }}' => 'Users List',
    '{{ HEADER_ASIDE_MENU_USERS_CHATS }}' => 'Chats List',
    '{{ HEADER_ASIDE_MENU_CHAT_SEND }}' => 'Send message',
