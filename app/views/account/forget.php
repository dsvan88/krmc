<form class="modal-form" method="POST" action="/account/forget">
    ...
    <h3 class="modal-form__subtitle">Для отримання посилання, розпочніть спілкування з нашим <a href="<?= $texts['tgBotLink'] ?>" target="_blank">ботом</a>,</br> й зареєструйте собі ім’я, якщо ви цього не зробили раніше.</h3>
