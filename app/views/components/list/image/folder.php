<input type="radio" name="image-radio" class="image__radio" id="r_<?= $file['id'] ?>" data-name="<?= $file['name'] ?>" data-action-change="show-folder-info" data-action-dblclick="open-images-folder">
