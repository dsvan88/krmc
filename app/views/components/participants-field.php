<div class="booking__participant">
    ...
    <div class="booking__participant-info">
        <input name="participant[]" type="text" value="<?= empty($participant) ? '' : $participant['name'] ?>" class="booking__participant-name" data-action-input="autocomplete-users-names" list="users-names-list" autocomplete="off" data-action-change="participant-check-change" />
